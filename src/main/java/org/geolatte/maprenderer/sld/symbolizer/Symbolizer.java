...
public interface Symbolizer {
    ...
    SymbolizerBuilder.UnitsOfMeasure getUom();

    void setUom(SymbolizerBuilder.UnitsOfMeasure uom);
    ...
    void setGraphics(MapGraphics graphics);

    void symbolize(Feature feature);
}
