...
public class TestImageComparator {
    ...
    public void testSameImageReturnsTrue() throws IOException {
        RenderedImage img1 = ExpectedImages.get("expected-test-simple-offset-painter.png");
        RenderedImage img2 = ExpectedImages.get("expected-test-simple-offset-painter.png");
    ...
    public void testModigiedImageReturnsFalse() throws IOException {
        RenderedImage img1 = ExpectedImages.get("expected-test-simple-offset-painter.png");
        RenderedImage img2 = ExpectedImages.get("expected-test-simple-offset-painter-edited.png");
